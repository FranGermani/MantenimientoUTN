...
-- Insertar los tipos de orden en la tabla tipo_orden
INSERT INTO tipo_orden (descripcion)
VALUES ('Inspeccion'),
       ('Mant. Prev. Planif.'),
       ('Planif. NO Period.'),
       ('NO Planificado');
...
CREATE TABLE orden_trabajo (
  ...
  id_tipo_orden INT NOT NULL,  -- Columna id_tipo_orden como clave foránea
  ...
  KEY id_tipo_orden (id_tipo_orden),  -- Crear un índice para id_tipo_orden
  ...
  CONSTRAINT orden_trabajo_ibfk_8 FOREIGN KEY (id_tipo_orden) REFERENCES tipo_orden (id_tipo_orden) -- Relación con la tabla tipo_orden
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
